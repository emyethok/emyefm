...
var cstrLoadFreePlayer = function() {
    ...
    var n = e.firstChild.nodeValue,
        ...
        d = t.href
		console.log(a);
    if ("Radio Online" != n || ["", ""].indexOf(a) == -1  || "Radio Broadcaster" != r || ["", ""].indexOf(d) == -1) alert("Please do not remove the .\n  IT IS GOING TO BE HIDDEN ANYWAY.")
    else {
        e.style.width = "1px", e.style.display = "true", e.style.height = "1px", e.style.opacity = "0" , t.style.width = "1px", t.style.height = "1px", t.style.opacity = "0", t.style.display = "true"
